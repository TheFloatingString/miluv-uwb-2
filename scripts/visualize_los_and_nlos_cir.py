...
df_los = pd.read_csv("data/processed_data/miluv-random_1-ifo001-uwb_cir_0.csv")  # 0,2,5: LOS
df_nlos_styrofoam = pd.read_csv("data/processed_data/miluv-random_1-ifo001-uwb_cir_1.csv") # 1: styrofoam
df_nlos_plastic = pd.read_csv("data/processed_data/miluv-random_1-ifo001-uwb_cir_3.csv") # 3: plastic
df_nlos_wood = pd.read_csv("data/processed_data/miluv-random_1-ifo001-uwb_cir_4.csv") # 4: wood
